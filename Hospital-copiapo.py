...
#--------------------------------------------------------------------------ACCIONES FRAME 1----------------------------------------------------------------------------------  
    ...
    def Exel_Medico(self):
        ...
        df.to_excel(f'D:\Descargas\Prueba 2 poo\Excel\Datos_Medicos_{fecha_archivo}.xlsx')
...
#--------------------------------------------------------------------------ACCIONES FRAME 2----------------------------------------------------------------------------------  
    ...
    def Exel_Tens(self):
        ...
        df2.to_excel(f'D:\Descargas\Prueba 2 poo\Excel\Datos_Tens_{fecha_archivo}.xlsx')
        messagebox.showinfo('Informacion','Excel creado correctamente')
...
class Ventana_pacientes(Frame):
    ...
    def Exel_Paciente(self):
        ...
        df=pd.DataFrame(datos2)
        df.to_excel(f'D:\Descargas\Prueba 2 poo\Excel\Datos_Pacientes_{fecha_archivo}.xlsx')
        messagebox.showinfo('Informacion','Excel creado correctamente')
...
class Ventana_personal(Frame):
    ...
    def Exel_Personal(self):
        ...
        df=pd.DataFrame(datos2)
        df.to_excel(f'D:\Descargas\Prueba 2 poo\Excel\Datos_Personal_{fecha_archivo}.xlsx')
        messagebox.showinfo('Informacion','Excel creado correctamente')
...
class Ventana_pago_personal(Frame):
    ...
    def Exel_Pago_personal(self):
        ...
        df=pd.DataFrame(datos2)
        df.to_excel(f'D:\Descargas\Prueba 2 poo\Excel\Datos_Pago_Personal_{fecha_archivo}.xlsx')
        messagebox.showinfo('Informacion','Excel creado correctamente')
...
class Ventana_cobro_paciente(Frame):
    ...
    def Exel_Cobro_paciente(self):
        ...
        df=pd.DataFrame(datos2)
        df.to_excel(f'D:\Descargas\Prueba 2 poo\Excel\Datos_Cobro_Consulta_{fecha_archivo}.xlsx')
        messagebox.showinfo('Informacion','Excel creado correctamente')
...
class Ventana_Busquedas_2(Frame):
    ...
    def Exel_Sueldos_ordenados(self):
        ...
        df=pd.DataFrame(datos2)
        df.to_excel(f'D:\Descargas\Prueba 2 poo\Excel\Datos_Sueldos_Ordenados_{fecha_archivo}.xlsx')
        messagebox.showinfo('Informacion','Excel creado correctamente')
    ...
    def Exel_Fechas_ordenadas(self):
        ...
        df=pd.DataFrame(datos2)
        df.to_excel(f'D:\Descargas\Prueba 2 poo\Excel\Datos_Fechas_Ordenados_{fecha_archivo}.xlsx')
