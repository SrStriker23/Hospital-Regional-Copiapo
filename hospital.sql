...
CREATE TABLE `cobro paciente` (
  ...
  `Prevision de salud` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `medico` (
  `id` int(11) NOT NULL,
  `Rut` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `Nombre` varchar(100) NOT NULL,
...
CREATE TABLE `pacientes` (
  ...
  `Derivacion` varchar(100) NOT NULL,
  `Medico atencion` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `Box` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
